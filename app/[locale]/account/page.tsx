...
export default async function AccountPage({
  ...
  return (
    <main className="container-page max-w-4xl py-10 md:py-14">
      ...
      <section className="mb-5 overflow-hidden rounded-xl border border-border bg-background shadow-card">
        <div className="flex items-center justify-between gap-3 border-b border-border bg-paper px-5 py-3.5">
      ...
      <section className="mb-5 overflow-hidden rounded-xl border border-border bg-background shadow-card">
        ...
        <div className="p-5">
          {addresses.length === 0 ? (
            <p className="rounded-md border border-dashed border-border bg-paper p-4 text-center text-sm text-muted-foreground">
      ...
      <section className="overflow-hidden rounded-xl border border-border bg-background shadow-card">
        ...
        <div className="p-5">
          {orders.length === 0 ? (
            <div className="rounded-md border border-dashed border-border bg-paper p-8 text-center text-sm">
