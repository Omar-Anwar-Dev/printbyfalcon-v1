...
const styles = StyleSheet.create({
  ...
  // Sprint 15 hotfix #2: SKU codes can be 16+ chars (e.g.
  // ACC-TONER-VACUUM); old width: 80 caused overflow into the name column.
  // Wider cell + smaller font = no overlap, and SKUs stay readable.
  cellSku: { width: 105, fontSize: 8.5 },
  cellName: { flex: 1 },
